...
import { generateArtistBenefitsPromo } from "@/ai/flows/generate-artist-benefits-promo";
import type { GenerateArtistBenefitsPromoInput } from '@/ai/flows/generate-artist-benefits-promo';
...
export async function fetchArtistBenefitsPromoImage(input: { benefits: GenerateArtistBenefitsPromoInput[] }) {
