...
export type GenerateArtistBenefitsPromoInput = z.infer<typeof BenefitSchema>;
...
export async function generateArtistBenefitsPromo(input: { benefits: GenerateArtistBenefitsPromoInput[] }): Promise<PromoImageOutput> {
